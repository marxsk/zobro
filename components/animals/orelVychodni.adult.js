  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[0]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        <AnimalText>
       Orel východní neboli kamčatský je nejtěžším dravcem na světě a je také největším orlem planety. Kvůli vzrůstajícímu znečištění ovzduší patří k&nbsp;ohroženým druhům – je klasifikován jako zranitelný. Původem je z&nbsp;východní Asie. Hnízdí blízko u&nbsp;vodních toků na Kamčatském poloostrově a v&nbsp;pobřežních oblastech Ochotského moře. Na zimu se přesouvá na jih k&nbsp;Japonsku, kde se vyskytuje hlavně na ostrově Hokaidó. 
        </AnimalText>
        <AnimalText>
