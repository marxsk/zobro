    ...
    return (
      <AnimalTemplate firstIndex={[0]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
       ...
       <InPageImage indexes={[1]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator} />
        ...
        <AnimalText>
        Samičky snáší 2 až 6 vajíček, z&nbsp;nichž se pak po 27–29 dnech vylíhnou malí puštíci. Běžně se pak dožíváme až 25&nbsp;let. V&nbsp;brněnské zoo jsme mláďátka ještě neměli, avšak až se s&nbsp;mojí kamarádkou pořádně poznáme, jistě se nějakých dočkáte.
        </AnimalText>
      </AnimalTemplate>
    );
  }
