  ...
  render() {
    return (
      ...
      <InPageImage indexes={[0]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator} />
        <AnimalText>
        Obývá především tajgy od Norska až po Japonsko. Tento druh puštíka je v&nbsp;České republice kriticky ohroženým druhem. Přirozeně hnízdí v&nbsp;Beskydech nebo na Šumavě.
        </AnimalText>
        <AnimalText>
