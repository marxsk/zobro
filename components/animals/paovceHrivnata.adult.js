  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[2]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        <AnimalText>
          Paovce hřivnatá se latinsky nazývá <Text style={styles.italic}>Ammotragus lervia</Text> a anglicky <Text style={styles.italic}>Barbary sheeps</Text>. Paovce se vyskytují v&nbsp;horských oblastech severní Afriky, kolem 4000&nbsp;metrů nad mořem. Potřebují se pohybovat v&nbsp;oblastech, kde jim skály, stromy nebo keře poskytnou dostatek stínu.
        </AnimalText>
        <AnimalText>
