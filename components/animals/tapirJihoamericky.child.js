  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[0]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        ...
        <AnimalText>
          Narodil jsem se tady v&nbsp;zoo na začátku roku 2015. Žil jsem tady s&nbsp;mámou Neny a tátou Cuzcem. Jak vás asi napadlo, náš druh je z&nbsp;Jižní Ameriky, žijeme tam v&nbsp;deštných pralesech. Různí naši bratránci žijou třeba v&nbsp;Asii, prostě na dalších místech, kde jsou deštný pralesy. Ale teď vám budu povídat o&nbsp;nás. 
        </AnimalText>
        <AnimalText>
      ...
      <InPageImage indexes={[1]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator} />
        <AnimalText>
          Pokud se vedle nás postavíte, budete skoro určitě vyšší než my. Na výšku dorůstáme nejvíc metr, zato tělo máme dlouhý až dva metry, takže pokud váš taťka nebourá hlavou do futer, nemá na nás ani on. A protože nejsme žádný tintítka, vážíme přes sto kilo, můžem mít klidně i&nbsp;250&nbsp;kilo, což je zhruba stejně jak deset osmiletejch dětí.
        </AnimalText>
