  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[0]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        ...
        <AnimalText>
        my jsme bobři kanadští a tady v&nbsp;Bystrci bydlíme od roku 2003. Přivezli nás sem ze Zooparku v Chomutově a celkově nás přijelo pět. Pocházíme ze Severní Ameriky, což je odsud hodně daleko, až za oceánem.
        </AnimalText>
        <AnimalText>
