  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[0]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        ...
        <AnimalText>
          Když se cítím unavený a chce se mi spát, zalezu si do svého hnízda, které mám v&nbsp;mělkém důlku v&nbsp;zemi. Mám ho vystlané různými kamínky a listy. Tam je moje království.
        </AnimalText>
      </AnimalTemplate>
    );
  }
