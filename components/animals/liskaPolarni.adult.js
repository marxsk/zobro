    ...
    return (
      <ScrollView>
        ...
        <View style={styles.scrollView}>
          <AnimalText>
            Lišky polární, latinsky Alopex (nebo Vulpes) lagopus patří k obyvatelům tundry. Kromě takových míst jako je Sibiř, Kanada nebo Aljaška obývají i řadu ostrovů. Samozřejmě Island, kde jsou jediný původní suchozemský savec, a Grónsko, ale i spoustu menších ostrovů. Na některých byly v devatenáctém století vysazovány obchodníky s kožešinami. Liška polární má totiž tak teplý kožich, že vydrží i teploty klesající pod – 50 °C. (A kdo by z něčeho takového nechtěl fešný kabátek.)
          </AnimalText>
          <AnimalText>
