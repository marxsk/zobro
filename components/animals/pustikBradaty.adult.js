  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[0]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        ...
        <AnimalText>
        Doma jsme v&nbsp;Severní Americe, severní Evropě i&nbsp;Asii. Žijeme v lesích do nadmořské výšky 3&nbsp;200&nbsp;m (což jsou zhruba dvě Sněžky). Dožíváme se okolo 20&nbsp;let, v&nbsp;zoo i&nbsp;40&nbsp;let. Náš největší nepřítel je třeba výr virginský – jen se sami podívejte, jak napruzeně se tváří. Určitě nám závidí, že nám neodstávají uši jako výrům. 
        </AnimalText>
        ...
        <AnimalText>
        Preferujeme hnízda na pahýlech starých stromů nebo v&nbsp;jejich dutinách, kam snášíme obvykle 2-5 vajec, pokud se chlap umí postarat a je dost potravy. Někdy náš partner dokonce hladoví, aby svou rodinu nakrmil, takže vydržovat víc partnerek se nevyplatí a žijeme v&nbsp;trvalých párech. O&nbsp;vejce se staráme samy, ale o&nbsp;potravu pro vylíhnutá mláďata se už staráme oba. V&nbsp;případě jejich ohrožení neváháme napadnout velkou šelmu i&nbsp;člověka. Takže od hnízda si držte odstup, jasné? Naše zlatíčka opouští hnízdo ve třech až čtyřech týdnech, jakmile se naučí dobře šplhat. 
        </AnimalText>
        <AnimalText>
