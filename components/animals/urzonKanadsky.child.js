  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[2]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        ...
        <AnimalText>
          Já i&nbsp;Liara máme robustní postavu a vážíme obvykle 4&nbsp;až 7&nbsp;kilogramů. Někteří z&nbsp;nás však mohou vážit až 18&nbsp;kilogramů. Svrchní část našich těl je pokryta dutými ostny, které slouží jako ochrana před predátory. Horní část těla máme obvykle tmavě hnědou až černou a na spodní jsou tmavé chlupy bez ostnů. Ocas je krátký a silný. Na tlapkách máme vpředu čtyři prsty, vzadu pět a na nich mohutné zahnuté drápy, které nám pomáhají v&nbsp;lezení.
        </AnimalText>
        ...
        <AnimalText>
          Naše mláďata jsou dobře vyvinutá, váží přibližně 340&nbsp;až 640&nbsp;gramů. Kůži mají pokrytou dlouhými černými chlupy a měkkými krátkými ostny, které do několika hodin ztvrdnou. Téměř ihned po narození jsou naše mláďata schopna následovat svoji maminku. Ve věku dvou dnů už lezou po stromech.
        </AnimalText>
        <AnimalText>
