  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[2]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        <AnimalText>
          Dželada je opice, která je blízká příbuzná paviánů. Od nich se však liší červenou lysinou na prsou. Díky tomuto charakteristickému znaku se dželadám přezdívá „pavián s&nbsp;krvácejícím srdcem“.
        </AnimalText>
        <AnimalText>
