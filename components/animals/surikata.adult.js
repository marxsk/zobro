  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[1]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        <AnimalText>
          Surikata, která v&nbsp;češtině nemá druhé jméno a odborný název ji odbyl pojmenováním <Text style={styles.italic}>Suricata suricatta</Text>, je šelma nepříliš velkého vzrůstu, měří zhruba 30&nbsp;centimetrů, k&nbsp;tomu má ocas dlouhý 20&nbsp;centimetrů a váží necelé kilo. Kromě toho se vyznačuje výskytem na západě jihu Afriky, v&nbsp;polopouštích a suchých stepích, kde se baví mimo jiné hloubením nor, ve kterých žijí početné surikatí klany. Do podzemí se ale schovávají jen před nebezpečím nebo při velkém žáru, surikaty se rády sluní venku.
        </AnimalText>
        <InPageImage indexes={[2]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator} />
        <AnimalText>
          Jedna nora může mít klidně 90&nbsp;východů a plochu tunelů v&nbsp;řádu stovek metrů čtverečních. To je číslo vzhledem k&nbsp;velikosti průměrné surikaty obdivuhodné, práci jim ovšem usnadňuje, že mají k&nbsp;hrabání uzpůsobené drápy, díky nimž dokážou za vteřinu vyházet tolik písku, co samy váží. Navíc v&nbsp;jedné kolonii surikat žije 10–30&nbsp;jedinců, tedy 2&nbsp;či 3&nbsp;rodiny včetně mláďat.
        </AnimalText>
        <AnimalText>
