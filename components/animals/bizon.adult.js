  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[0]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        ...
        <AnimalText>
        Doby, kdy v&nbsp;Severní Americe žilo 60&nbsp;milionů bizonů, kteří migrovali v&nbsp;tisícihlavých stádech, jsou dávno pryč. Po příchodu „bílých bratrů“ z&nbsp;Evropy se museli Indiáni smířit s&nbsp;tím, že jejich zdroj potravy i&nbsp;materiálu na oděvy bude takřka vyhuben a že i&nbsp;oni se ocitnou v&nbsp;krutých rukou osadníků.
        </AnimalText>
        <InPageImage indexes={[1]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator} />
        <AnimalText>
        V&nbsp;polovině 19.&nbsp;století dala americká vláda impulz k&nbsp;masovému vybíjení bizonů za účelem vyhladovění Indiánů a zisku jejich půdy. Počet bizonů klesl pod 1000 jedinců. V&nbsp;minulém století se naštěstí podařilo počty bizonů zvýšit. Počítá se asi s&nbsp;půl milionem jedinců, avšak většina z&nbsp;nich je zkřížena s&nbsp;dobytkem a napolo domestikována. Své latinské pojmenování <Text style={styles.italic}>bison</Text> (celým názvem <Text style={styles.italic}>Bison bison</Text>), které lze interpretovat jako „divoký tur“, by charakterizovalo jen kolem 30&nbsp;000 jedinců žijících v&nbsp;rezervacích a asi 5000 zdravých jedinců pohybujících se v&nbsp;neoplocených areálech.
        </AnimalText>
        <AnimalText>
        Americkým bizonům se podobá bizon evropský, který je známější pod názvem zubr. Měl v&nbsp;Evropě podobný osud jako bizon americký a jeho populaci se podařilo zachránit jen díky posledním 56 zubrům, kteří žili v&nbsp;oborách.
        </AnimalText>
