  ...
  render() {
    return (
      ...
      <AnimalTemplate firstIndex={[1]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        <AnimalText>
          Jsme divocí. Ve volné přírodě žijeme převážně sami, svá teritoria o&nbsp;velikosti až 500&nbsp;km<Text style={styles.superscript}>2</Text> si značkujeme jako skunkové. Potkáváme se jen v&nbsp;létě, když chceme zakládat rodiny. Devět měsíců nato se samičkám narodí 1–5&nbsp;mláďat. Dříve se věřilo, že se rodíme jako medvíďata, a to tak, že pokud se medvědici narodí čtyři mláďata, z&nbsp;toho čtvrtého vyroste rosomák. Ale tak to rozhodně není. I&nbsp;když se o&nbsp;nás povídá, že kdybychom dorostli velikosti medvěda, byli bychom nejsilnějšími zvířaty na světě.
        </AnimalText>
        <AnimalText>
