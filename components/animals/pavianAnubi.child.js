  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[0]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        ...
        <AnimalText>
        Těšil se, jak si svým šarmem získá urozenou slečnou, jak s&nbsp;ní bude žrát z&nbsp;jednoho talíře a ochrání ji před vším zlým. To však ještě nevěděl, že i&nbsp;na cestě na něj číhá spousta nebezpečí.
        </AnimalText>
        <AnimalText>
        ...
        <AnimalText>
        Paviánka však měla jasno, komu chce fandit. V&nbsp;dlaních zahřála kousek ovoce a hodila ho našemu unavenému cestovateli: „Jez, dodá ti to energii!“ V&nbsp;ovoci bylo tolik síly a lásky, že se pavián vzchopil a pustil se do boje. Skřípal zuby, hrozivě cenil své velké špičáky a hřmotným hlasem řval jako pavián. Soupeř se musel vzdát.
        </AnimalText>
        <AnimalText>
