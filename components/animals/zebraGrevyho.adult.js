  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[0]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        ...
        <AnimalText>
          Samec a samice mohou žít samostatně – mimo stádo. To nastává hlavně v&nbsp;případech, když se zebra rozhodne najít prostředí s&nbsp;lepšími životními podmínkami. Přesto se nejčastěji sdružují do stád, protože se tak lépe ubrání predátorům. Nejčastějšími predátory zebry bývají lvi, hyeny, gepardi nebo krokodýli.
        </AnimalText>
        <AnimalText>
        ...
        <AnimalText>
          Ve stádech s&nbsp;mláďaty existují tzv. školky. Když zebry jdou hledat vodu či jídlo, mláďata s&nbsp;sebou neberou. Ta zůstanou pod dozorem jedné samice a jednoho samce. Samice se stará o&nbsp;mláďata a samec celou skupinku chrání.
        </AnimalText>
        <AnimalText>
          V&nbsp;přírodě se stáda zebry Grévyho a Chapmanovy mohou spojovat a žít spolu.
        </AnimalText>
        <AnimalText>
          Na závěr jsme si nechali jeden důležitý fakt... Co myslíte, je zebra bílá s&nbsp;černými pruhy, nebo černá s&nbsp;bílými pruhy? Že to nejde určit? No, běžný pozorovatel to nepozná. Avšak představte si, že to určeno bylo. Embryologické studie prokázaly, že srst zebry je černá a bílé pruhy jsou pigment.
        </AnimalText>
      </AnimalTemplate>
    );
  }
