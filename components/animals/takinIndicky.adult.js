  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[2]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        ...
        <AnimalText>
          Bohužel i&nbsp;přes svoji hbitost, připisovanou spíše kamzíkům, je takin indický na stupních ohrožení zranitelným druhem – na světě už jich není více než půl čtvrtého tisíce. Vyskytuje se na jihu Číny, v&nbsp;indickém státě Asám, v&nbsp;Tibetu a Bhútánu, ale i&nbsp;v&nbsp;Barmě. Obvykle žije ve výšce 2&nbsp;500&nbsp;až 4&nbsp;500&nbsp;metrů nad mořem. Takini se naštěstí docela činí, takže zatím není všem takiním dnům konec.
        </AnimalText>
